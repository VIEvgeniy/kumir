...
Сервис, обслуживающий веб-API для компиляции и других операций, также написан на **C++** с использованием моего легковесного фреймворка **[coroio](https://coroio.dev)**.
...
**Ссылки на coroio:**
- Сайт: [coroio.dev](https://coroio.dev)
- GitHub: [github.com/resetius/coroio](https://github.com/resetius/coroio)
...
Подробнее см. [Работа с файлами](files.md).
